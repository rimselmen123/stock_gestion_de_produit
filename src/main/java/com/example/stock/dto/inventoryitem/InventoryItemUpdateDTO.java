...
/**
 * Data Transfer Object for updating an existing InventoryItem.
...
public class InventoryItemUpdateDTO {
    ...
    /**
     * The updated name of the inventory item.
    ...
    /**
     * The updated threshold quantity for low stock alerts.
    ...
    /**
     * The updated quantity to reorder when stock is low.
    ...
    /**
     * The updated unit purchase price of the item.
    ...
    /**
     * The updated category ID this item belongs to.
     * Required field.
     */
    ...
    /**
     * The updated unit ID for this item.
     * Required field.
     */
